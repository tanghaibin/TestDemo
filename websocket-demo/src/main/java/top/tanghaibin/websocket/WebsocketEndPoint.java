...
public class WebsocketEndPoint {
    ...
    private static Logger log = org.slf4j.LoggerFactory.getLogger(WebsocketEndPoint.class);
    ...
    public String onMessage(@PathParam("relationId") String relationId,
                            @PathParam("userCode") int userCode,
                            String message) {
        sendMessage(relationId, userCode, message);
     ...
     * @param message
     */
    public void sendMessage(String relationId, int userCode,String message){
        SessionUtils.broadcast("zhangsan", 1, message);
    }
}